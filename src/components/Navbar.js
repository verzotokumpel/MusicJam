...
function Navbar() {
  ...
  return (
     <div className={scrolled ? '!z-50 fixed w-full bg-[#f8f8f8] shadow-md' : '!z-50 fixed w-full bg-[#f8f8f8] '}>
        <div className='flex justify-between items-center py-4 sm:py-8 max-w-[1140px] mx-auto px-4'>
        <Link to='Hero' spy={true} smooth={true} offset={-300} duration={500}><img src={logo} alt="logo" className='max-w-[44px] sm:max-w-[58px]'/></Link>
